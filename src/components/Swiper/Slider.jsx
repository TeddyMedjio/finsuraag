    ...
    <>
      ...
      >
        <SwiperSlide className=" z-40">
          ...
          <div className="absolute left-0 top-0 bg-white w-full h-full opacity-70 z-[41] md:hidden"></div>
          <Image src={family} height="auto" alt="image d'une famille" />
        </SwiperSlide>

        <SwiperSlide className="family2 z-40">
          <div className="relative container mx-auto z-[45]">
            <div className="max-w-[550px] md:max-w-full lg:max-w-[550px] absolute right-0 top-0 mt-[50%] lg:mt-[20%] text-center lg:text-left  ">
              <h1 className="text-brand-blue font-bold text-5xl">
                Schutz im Alltag
              </h1>
              <p className=" text-4xl text-black mt-5 mb-10">
          ...
          <div className="absolute left-0 top-0 bg-white w-full h-full opacity-40 z-[41] md:hidden"></div>
