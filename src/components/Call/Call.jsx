...
export default function Call() {
  return (
    <div className="bg-brand-gray py-10">
      <div className="container mx-auto px-5 md:px-0 flex items-center justify-between flex-col text-center lg:text-left lg:flex-row">
        <div>
          <h3 className=" text-2xl font-bold text-white mb-2">
            Hast du Fragen zu unseren Dienstleistungen? Rufe uns ganz einfach an
          </h3>
          <p className=" text-lg text-white mb-10 lg:mb-0">
